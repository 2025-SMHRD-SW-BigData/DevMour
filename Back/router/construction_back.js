...
router.get('/list', async (req, res) => {
    try {
        ...
        const constructions = rows.map(row => ({
            ...
            control_st_tm: row.control_st_tm ? row.control_st_tm.toISOString() : null,
...
router.get('/detail/:id', async (req, res) => {
    try {
        ...
        construction.control_st_tm = construction.control_st_tm ? construction.control_st_tm.toISOString() : null;
        construction.control_ed_tm = construction.control_ed_tm ? construction.control_ed_tm.toISOString() : null;
        construction.created_at = construction.created_at ? construction.created_at.toISOString() : null;
